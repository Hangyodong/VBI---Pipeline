...
cfg = PipelineConfig(
    ...
    # ── Prior bounds (edit directly) ──
    PRIOR_P_LOW   = 0.0,  PRIOR_P_HIGH   = 3.0,
    PRIOR_Q_LOW   = 0.0,  PRIOR_Q_HIGH   = 3.0,
    PRIOR_GE_LOW  = 0.0,  PRIOR_GE_HIGH  = 1.0,
    PRIOR_GI_LOW  = 0.0,  PRIOR_GI_HIGH  = 1.0,
    PRIOR_CEI_LOW = 6.0,  PRIOR_CEI_HIGH = 18.0,  # c_ei inferred
    ...
    # ── Phase-2 attention × gradient FC selection ──
    SELECTION_K                = 300,
